...
ranges = (
    ...
    slice( 0.0 , 1.0 , 0.1 ),  # mu_min,   mu_max,   mu_step
    slice( 0.0 , 0.1 , 0.01),  # x0_min,   x0_max,   x0_step
    slice(-0.1 , 0.0 , 0.1 ),  # x0'_min,  x0'_max,  x0'_step
    slice(-0.1 , 0.0 , 0.1 ),  # epsf_min, epsf_max, epsf_step
    slice(-1.0 , 0.0 , 0.1 )   # V_min,    V_max,    V_step
)
...
params = brute(func, ranges, args=(xdata, ydata, sigma), finish=fmin, disp=True)
